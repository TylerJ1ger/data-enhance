// frontend/src/components/backlink/BrandDomainOverlap.tsx
...
const BrandDomainOverlap: React.FC<BrandDomainOverlapProps> = ({
  brandOverlapData,
  isLoading = false,
}) => {
  if (isLoading) {
  ...
  return (
    <div className="card mb-6">
      <h3 className="text-lg font-medium text-gray-800 mb-4">品牌域名重叠分析</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          <div className="flex items-center mb-2">
            <div className="mr-2 text-primary-600"><FiCircle /></div>
            <h4 className="text-sm font-medium text-gray-700">域名总数</h4>
          </div>
          <div className="text-2xl font-bold text-gray-900">{summary.totalDomains.toLocaleString()}</div>
        </div>
        
        <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
          <div className="flex items-center mb-2">
            <div className="mr-2 text-primary-600"><FiLink /></div>
            <h4 className="text-sm font-medium text-gray-700">平均重叠域名</h4>
          </div>
        ...
        <div className="bg-white rounded-lg border border-primary-200 p-4 mb-6 text-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="bg-primary-100 text-primary-800 px-2 py-1 rounded">
              共享 <span className="font-bold">{summary.maxOverlap}</span> 个域名
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <h4 className="text-sm font-medium text-gray-700 mb-2">品牌域名重叠可视化</h4>
...
export default BrandDomainOverlap;