...
# Backlink functionality moved to v1 API
...
# Backlink processors moved to v1 API
...
# Backlink models moved to v1 API
...
# Backlink functionality moved to v1 API at /api/v1/backlinks/
# All legacy backlink routes have been migrated to v1
